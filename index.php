...
<html lang="en">
  ...
  <nav class="navbar fixed-top navbar-expand-lg py-3 navbar-dark" style="background-color: #000080;">
    ...
    if (isset($_GET['page'])) {
        ...
        echo "<br><h1>Selamat Datang di Poliklinik,";
        echo "<br><h2>Bersabarlah, Sakit adalah Cara untuk menghapus dosa-dosamu. Sebentar lagi kamu pasti akan sembuh";
        if (isset($_SESSION['username'])) {
            //jika sudah login tampilkan username
            echo ". " . $_SESSION['fullname'] . "</h2><hr>";
        } else {
            echo "</h1><hr>Silakan Login untuk menggunakan sistem. Jika belum memiliki akun silakan Register terlebih dahulu.";
        }
    }
    ?>
    </main>
